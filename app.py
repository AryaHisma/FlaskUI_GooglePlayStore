...
def index():
    ...
    stats = {
        ...
        'rev_table' : df2.nlargest(10, 'Reviews')[['Category', 'App', 'Reviews', 'Rating']].reset_index(drop=True).to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
